...
Это **не учебный todo-лист, а живой бот в проде**: я спроектировал, написал и **покрыл автотестами** весь цикл — от регистрации по инвайту до пересчёта рейтинга и вечерних сводок. Тестировал так дотошно, что багов в коде поймал, кажется, больше, чем выиграл матчей.
