...
| Достижения | `tests/test_achievements.py` | все 29 ачивок, идемпотентность, бэкфилл по истории (in-memory SQLite) |
...
- Система достижений (29 ачивок) и пасхалки после матчей
