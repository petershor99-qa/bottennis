...
```bash
pytest -v          # 483 автотеста, ~7 секунд
```

- **483 автотеста** на `pytest` + `pytest-asyncio` (юнит чистой логики + тесты хендлеров)
...
<details>
<summary><b>Полный список фич — нажми, чтобы развернуть</b></summary>
...
├── tests/                      # 483 автотеста (юнит + хендлеры)
