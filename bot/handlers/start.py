...
async def cmd_help(message: Message):
    await message.answer(
        ...
        "• 🏆 Внести результат — победитель вводит партии, любой из участников\n"
        "• 🤝 Поддерживается ничья\n"
        "• ❌ Отмена матча любым участником (с подтверждением)\n"
        "• ⚔️ Реванш — кнопка сразу после матча\n\n"
        "<b>Статистика:</b>\n"
        "• 📊 Таблица рейтинга с серией побед 🔥 и винрейтом\n"
        "• 👤 Профиль любого игрока — с кнопкой вызова\n"
        "• 📈 Личная статистика — форма за 7 дней, топ-соперник, карьерный рейтинг\n"
        "• 📜 Полная история матчей с пагинацией\n"
        "• 📈 История рейтинга — последние 20 матчей с дельтой\n"
        "• 🏅 Достижения — 21 ачивка с отсылками к играм и мемам\n\n"
        "<b>Напоминания:</b>\n"
        "• ⏰ Матч не сыгран 24 часа — напоминание обоим\n"
        "• 📊 Еженедельный дайджест каждый понедельник в 9:00\n\n"
